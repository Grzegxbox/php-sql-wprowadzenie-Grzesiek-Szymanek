...
echo("<h3>7. SELECT imie, DATE_FORMAT('data_urodzenia', '%Y-%M-%W') AS dzur FROM pracownicy WHERE (imie='Grzesiek')</h3>");
  $conn= new mysqli("remotemysql.com","Rp4CxP6YkY","V0BMRFi2V3","Rp4CxP6YkY");
    $result=$conn->query('SELECT imie, DATE_FORMAT("data_urodzenia", "%Y-%M-%W") AS dzur FROM pracownicy WHERE (imie="Grzesiek")');
        echo("<table border=2>");
        echo("<th>IMIĘ</th>");
